...
"  pass=PASSWORD      Password for all users\n"
"  master=USER        Master user to use for logins\n"
"  mech=MECH          Authentication mechanism (default: LOGIN)\n"
"\n"
"Connection & Network:\n"
...
"  clients=N          Number of concurrent clients [%u]\n"
"\n"
"Mailbox & Message Source:\n"
"  mbox=PATH          Path to mbox file for APPEND messages\n"
"  random_msg_size=S  Generate random mails of size S instead of using mbox\n"
"  box=NAME           Mailbox to use (default: INBOX)\n"
"  copybox=NAME       Destination mailbox for COPY\n"
"  msgs=N             Target number of messages in mailbox [%u]\n"
"\n"
"Testing & Control:\n"
"  secs=N[,FINAL]     Run for N seconds, wait FINAL for disconnect [30]\n"
"  test=DIR           Run scripted tests from directory\n"
"  profile=PATH       Use configuration from profile file\n"
...
"  no_pipelining      Don't send multiple commands at once\n"
"  no_tracking        Don't track and complain about IMAP state\n"
"  disconnect_quit    Quit if a client gets disconnected\n"
"  error_quit         Quit immediately on error\n"
"  rawlog             Write rawlog.* files for all connections\n"
"  own_msgs           Track message ownership\n"
